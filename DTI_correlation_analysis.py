...
DTI_corr = Workflow (name = 'DTI_correlation_analysis')
DTI_corr.base_dir = opj(experiment_dir, working_dir)
#-------------------------------------------------------------------------------------
...
DTI_corr.connect ([
      ...
      (selectfiles, palm_corr, [('all_skeleton','in_file')]),
      (selectfiles, palm_corr, [('skeleton_mask','mask')]),
